...
export default function Form({onFormSubmit, setOnFormSubmit}) {
  ...
  return (
    <div className='container mx-auto bg-pink-900 text-white border-4 border-double border-red-200'>



<form onSubmit={handleSubmit} className="max-w-sm mx-auto">
  <div className="mb-5">
    <label className="text-white block mb-2 text-sm font-medium  dark:text-white">Assignee email</label>
  ...
  <div className="mb-5">
    <label className="text-white block mb-2 text-sm font-medium  dark:text-white">Task Title</label>
  ...
  <div className="mb-5">
    <label className="text-white block mb-2 text-sm font-medium  dark:text-white">Task Tags(Separate your tags with a space )</label>
  ...
  <div className="mb-5">
    <label className="text-white block mb-2 text-sm font-medium  dark:text-white">Task Image</label>
  ...
  <div className="mb-5">
    <label className="text-white block mb-2 text-sm font-medium  dark:text-white">Task Status</label>
